...
namespace OrderAccounting.UIdesign
{
    ...
    public class Toggle : Control
    {
        ...
        public Color BackColorON { get; set; } = Color.FromArgb(77, 25, 77);
        public Color BackColorOFF { get; set; } = Color.FromArgb(0, 100, 102);
        ...
        private int ToogleSwitchWidth = 60;
        ...
        public Toggle()
        {
            ...
            Size = new Size(ToogleSwitchWidth, 25);
            UpdateSize();
            UpdateStructures();
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Pen penToggleHolder = new Pen(Color.FromArgb(0, 38, 66), 1.55f);
            Pen penToggle = new Pen(Color.FromArgb(0, 38, 66), 3);

            GraphicsPath gpathToggle = Rounding.RoundedRectangle(rectToggleHolder, rectToggleHolder.Height);
